  ...
  <span className="text-indigo-600">{" "}Pan-African Artificial Intelligence and Smart Systems </span> Conference
            ...
            <div data-aos="zoom-in" className="mt-5 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
              ...
              <div className="blinking text-base font-medium text-gray-500" style={{ marginTop: 10 }}>
                <Blink color='red' text='Due to the COVID-19 and based on many requests, the submission deadline has been extended to June 15, 2021.' fontSize='15' fontWeight='bold'></Blink>
              </div>
            </div>
          </div>
