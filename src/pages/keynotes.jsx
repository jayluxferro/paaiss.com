  ...
  <div className="relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
    <div className="lg:col-start-2 lg:pl-8">
      <div className="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
        ...
        <p data-aos="zoom-in"  className="text-lg leading-7 text-gray-500 mb-5 font-light mt-3"><span className={"font-medium underline"}>Presenter:</span> Dr Ernest Fokoué, School of Mathematical Sciences, Rochester Institute of Technology, Rochester, New York, USA</p>
        <p data-aos="zoom-in"  className="text-lg leading-7 text-gray-500 mb-5 font-light mt-3"><span className={"font-medium underline"}>Duration:</span> 1 Hour</p>
